classdef benthic_zH2S
    ...
    methods
        ...
        function r = calc(obj, bsd, swi, r)
            ...
            % AH2S*dedz5_zinf   +  BH2S*dfz4_zinf  + dgz4_zinf = 0;          % zero flux at zinf
            % AH2S*e1_0     +   BH2S*f1_0     + g1_0  = swi.H2S0;
            
            % | dedz5_zinf dfdz5_zinf |  |AH2S|   = | -dgz4_zinf       |
            ...
            %             r.conczso4h2s = rH2S.A5.*e5_zso4+rH2S.B5.*f5_zso4 + g5_zso4;
            ...
            r.flxswiH2S = bsd.por.*(obj.DH2S1.*(rH2S.A5.*dedz1_0+rH2S.B5.*dfdz1_0 + dgdz1_0) - bsd.w.*(swi.H2S0 - r.conczinfH2S));   % NB: use A5, B5 as these are _xformed_ layer 1 basis functions
