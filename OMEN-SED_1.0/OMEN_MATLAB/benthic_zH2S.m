    ...
    methods
        ...
        function r = calc(obj, bsd, swi, r)
            ...
            if(swi.TwoG_OM_model)
                ...
                % layer 3: zno3 < z < zfeIII, passive diffn
                rH2S.ls3 = r.zTOC.prepfg_l12(bsd, swi, r, 0,         0,         0,  r.zno3, r.zfeIII, obj.DH2S1, obj.DH2S2);
                % layer 4: zfeIII < z < zso4, H2S prod. by OM oxidation
                rH2S.ls4 = r.zTOC.prepfg_l12(bsd, swi, r, obj.reac1, obj.reac2, 0, r.zfeIII, r.zso4, obj.DH2S1, obj.DH2S2);
                % layer 5: zso4 < z < zinf, passive diffn
                rH2S.ls5 = r.zTOC.prepfg_l12(bsd, swi, r, 0,         0,         0, r.zso4, bsd.zinf, obj.DH2S1, obj.DH2S2);
                
                % Work up from the bottom, matching solutions at boundaries
                % Basis functions at bottom of layer 5 zinf
                [ e5_zinf, dedz5_zinf, f5_zinf, dfdz5_zinf, g5_zinf, dgdz5_zinf] ...
                    = r.zTOC.calcfg_l12(bsd.zinf, bsd, swi, r, 0, 0, 0, rH2S.ls5);
                
                % Match at zso4, layer 4 - layer 5 (continuity and flux with AOM production)
                % basis functions at bottom of layer 4
                [ e4_zso4, dedz4_zso4, f4_zso4, dfdz4_zso4, g4_zso4, dgdz4_zso4] ...
                    = r.zTOC.calcfg_l12(r.zso4, bsd, swi, r,  obj.reac1, obj.reac2, 0, rH2S.ls4);
                % ... and top of layer 5
                [ e5_zso4, dedz5_zso4, f5_zso4, dfdz5_zso4, g5_zso4, dgdz5_zso4] ...
                    = r.zTOC.calcfg_l12(r.zso4, bsd, swi, r,  0,  0, 0, rH2S.ls5);
                ...
                D = (r.zso4 <= bsd.zbio).*obj.DH2S1 + (r.zso4 > bsd.zbio).*obj.DH2S2;
                [zso4.a, zso4.b, zso4.c, zso4.d, zso4.e, zso4.f] = benthic_utils.matchsoln(e4_zso4, f4_zso4, g4_zso4, dedz4_zso4, dfdz4_zso4, dgdz4_zso4, ...
                    e5_zso4, f5_zso4, g5_zso4, dedz5_zso4, dfdz5_zso4, dgdz5_zso4, ...
                    0, -bsd.gammaCH4.*zso4FH2S./D);
                %Dom 24.02.2016: No *(1-gammaCH4)*zso4FH2S... missing here!
                
                
                % Match at zfeIII, layer 3 - layer 4 (continuity and flux)
                % basis functions at bottom of layer 3
                [ e3_zfeIII, dedz3_zfeIII, f3_zfeIII, dfdz3_zfeIII, g3_zfeIII, dgdz3_zfeIII] ...
                    = r.zTOC.calcfg_l12(r.zfeIII, bsd, swi, r,     0,            0, 0, rH2S.ls3);
                % ... and top of layer 4
                [ e4_zfeIII, dedz4_zfeIII, f4_zfeIII, dfdz4_zfeIII, g4_zfeIII, dgdz4_zfeIII] ...
                    = r.zTOC.calcfg_l12(r.zfeIII, bsd, swi, r, obj.reac1, obj.reac2, 0, rH2S.ls4);
                ...
                [ e3_zno3, dedz3_zno3, f3_zno3, dfdz3_zno3, g3_zno3, dgdz3_zno3] ...
                    = r.zTOC.calcfg_l12(r.zno3, bsd, swi, r, 0, 0, 0, rH2S.ls3);
                % ... transformed to use coeffs from l5
                ...
                zoxFH2S = r.zTOC.calcReac(r.zfeIII, r.zso4, bsd.SO4C, bsd.SO4C, bsd, swi, r) ... % MULTIPLY BY 1/POR ????
                ...
                % transform to use coeffs from l5
                ...
                % Preparation: for each layer, sort out solution-matching across bioturbation boundary if necessary
                % layer 1: 0 < z < zox, passive diffn
                %      ls =      prepfg_l12( bsd, swi, r, reac1,     ktemp, zU, zL, D1,        D2)
                rH2S.ls1 = r.zTOC_RCM.prepfg_l12(bsd, swi, r, 0,         0,     0, r.zox, obj.DH2S1, obj.DH2S2);
                % layer 2: zox < z < zno3, passive diffn
                rH2S.ls2 = r.zTOC_RCM.prepfg_l12(bsd, swi, r, 0,         0,  r.zox, r.zno3, obj.DH2S1, obj.DH2S2);
                % layer 3: zno3 < z < zfeIII, passive diffn
                rH2S.ls3 = r.zTOC_RCM.prepfg_l12(bsd, swi, r, 0,         0,  r.zno3, r.zfeIII, obj.DH2S1, obj.DH2S2);
                % layer 4: zfeIII < z < zso4, H2S prod. by OM oxidation
                rH2S.ls4 = r.zTOC_RCM.prepfg_l12(bsd, swi, r, obj.reac1, 0, r.zfeIII, r.zso4, obj.DH2S1, obj.DH2S2);
                % layer 5: zso4 < z < zinf, passive diffn
                rH2S.ls5 = r.zTOC_RCM.prepfg_l12(bsd, swi, r, 0,         0, r.zso4, bsd.zinf, obj.DH2S1, obj.DH2S2);
                
                % Work up from the bottom, matching solutions at boundaries
                % Basis functions at bottom of layer 5 zinf
                [ e5_zinf, dedz5_zinf, f5_zinf, dfdz5_zinf, g5_zinf, dgdz5_zinf] ...
                    = r.zTOC_RCM.calcfg_l12(bsd.zinf, bsd, swi, r, 0, 0, rH2S.ls5);
                
                % Match at zso4, layer 4 - layer 5 (continuity and flux with AOM production)
                % basis functions at bottom of layer 4
                [ e4_zso4, dedz4_zso4, f4_zso4, dfdz4_zso4, g4_zso4, dgdz4_zso4] ...
                    = r.zTOC_RCM.calcfg_l12(r.zso4, bsd, swi, r,  obj.reac1, 0, rH2S.ls4);
                % ... and top of layer 5
                [ e5_zso4, dedz5_zso4, f5_zso4, dfdz5_zso4, g5_zso4, dgdz5_zso4] ...
                ...
                % basis functions at bottom of layer 3
                [ e3_zfeIII, dedz3_zfeIII, f3_zfeIII, dfdz3_zfeIII, g3_zfeIII, dgdz3_zfeIII] ...
                    = r.zTOC_RCM.calcfg_l12(r.zfeIII, bsd, swi, r,     0, 0, rH2S.ls3);
                % ... and top of layer 4
                [ e4_zfeIII, dedz4_zfeIII, f4_zfeIII, dfdz4_zfeIII, g4_zfeIII, dgdz4_zfeIII] ...
                    = r.zTOC_RCM.calcfg_l12(r.zfeIII, bsd, swi, r, obj.reac1, 0, rH2S.ls4);
                % ... transformed to use coeffs from l5
                [e4_zfeIII, f4_zfeIII, g4_zfeIII, dedz4_zfeIII, dfdz4_zfeIII, dgdz4_zfeIII] = benthic_utils.xformsoln(e4_zfeIII, f4_zfeIII, g4_zfeIII, dedz4_zfeIII, dfdz4_zfeIII, dgdz4_zfeIII, ...
                    zso4.a , zso4.b , zso4.c , zso4.d , zso4.e ,zso4.f);
...
%                    0, 0);      % if S-cycle is adjusted for pyrite formation via the SWI-flux of H2S 
                ...
                % basis functions at bottom of layer 2
                [ e2_zno3, dedz2_zno3, f2_zno3, dfdz2_zno3, g2_zno3, dgdz2_zno3] ...
                    = r.zTOC_RCM.calcfg_l12(r.zno3, bsd, swi, r,     0,     0, rH2S.ls2);
                % ... and top of layer 3
                [ e3_zno3, dedz3_zno3, f3_zno3, dfdz3_zno3, g3_zno3, dgdz3_zno3] ...
                    = r.zTOC_RCM.calcfg_l12(r.zno3, bsd, swi, r, 0, 0, rH2S.ls3);
                % ... transformed to use coeffs from l5
                [e3_zno3, f3_zno3, g3_zno3, dedz3_zno3, dfdz3_zno3, dgdz3_zno3] = benthic_utils.xformsoln(e3_zno3, f3_zno3, g3_zno3, dedz3_zno3, dfdz3_zno3, dgdz3_zno3, ...
                    zfeIII.a , zfeIII.b , zfeIII.c , zfeIII.d , zfeIII.e ,zfeIII.f);
                % match solutions at zno3 - continuous concentration and flux
...
%                    - zfeIIIFFe2;               % - the flux of H2S used for pyrite precip. at zfeIII 
              ...
              %     boundaries and not at the SWI
                ...
                % basis functions at bottom of layer 1
                [ e1_zox, dedz1_zox, f1_zox, dfdz1_zox, g1_zox, dgdz1_zox] ...
                    = r.zTOC_RCM.calcfg_l12(r.zox, bsd, swi, r, 0 , 0, rH2S.ls1);
                % basis functions at top of layer 2
                [ e2_zox, dedz2_zox, f2_zox, dfdz2_zox, g2_zox, dgdz2_zox] ...
                    = r.zTOC_RCM.calcfg_l12(r.zox, bsd, swi, r, 0, 0, rH2S.ls2);
                % transform to use coeffs from l5
                [e2_zox, f2_zox, g2_zox, dedz2_zox, dfdz2_zox, dgdz2_zox] = benthic_utils.xformsoln(e2_zox, f2_zox, g2_zox, dedz2_zox, dfdz2_zox, dgdz2_zox, ...
                    zno3.a , zno3.b , zno3.c , zno3.d , zno3.e ,zno3.f);
...
%                    0, r.zxf.*bsd.gammaH2S.*zoxFH2S./D -zfeIIIFFe2./D);
                ...
                % Solution at swi, top of layer 1
                [ e1_0, dedz1_0, f1_0, dfdz1_0, g1_0, dgdz1_0] ...
                    = r.zTOC_RCM.calcfg_l12(0, bsd, swi, r, 0 , 0, rH2S.ls1);
                % transform to use coeffs from l5
                [ e1_0, f1_0, g1_0, dedz1_0,  dfdz1_0, dgdz1_0]= benthic_utils.xformsoln(e1_0, f1_0, g1_0, dedz1_0, dfdz1_0, dgdz1_0, ...
                    zox.a , zox.b , zox.c , zox.d , zox.e ,zox.f);
            ...
            [ rH2S.A5, rH2S.B5]      = benthic_utils.solve2eqn(dedz5_zinf, dfdz5_zinf, e1_0, f1_0, -dgdz5_zinf, swi.H2S0 - g1_0);
            
            %             % calculate conc and flux at zso4
            %             r.conczso4h2s = rH2S.A5.*e4_zso4+rH2S.B5.*f4_zso4 + g4_zso4;
            % calculate concentration at zinf
            r.conczinfH2S = rH2S.A5.*e5_zinf+rH2S.B5.*f5_zinf + g5_zinf;
            
            
            % flux at swi - DO include por so this is per cm^2 water column area
            % DH: added advective flux 28.05.2016
            r.flxswiH2S = bsd.por.*(obj.DH2S1.*(rH2S.A5.*dedz1_0+rH2S.B5.*dfdz1_0 + dgdz1_0) - bsd.w.*(swi.H2S0 - r.conczinfH2S));   % NB: use A4, B4 as these are _xformed_ layer 1 basis functions
            
            % save coeffs for layers 4, 3, 2 and 1
            rH2S.A4 = zso4.a.*rH2S.A5 + zso4.b.*rH2S.B5 + zso4.e;
            rH2S.B4 = zso4.c.*rH2S.A5 + zso4.d.*rH2S.B5 + zso4.f;
            
            rH2S.A3 = zfeIII.a.*rH2S.A5 + zfeIII.b.*rH2S.B5 + zfeIII.e;
            rH2S.B3 = zfeIII.c.*rH2S.A5 + zfeIII.d.*rH2S.B5 + zfeIII.f;
            
            rH2S.A2 = zno3.a.*rH2S.A5 + zno3.b.*rH2S.B5 + zno3.e;
            rH2S.B2 = zno3.c.*rH2S.A5 + zno3.d.*rH2S.B5 + zno3.f;
            
            rH2S.A1 = zox.a.*rH2S.A5 + zox.b.*rH2S.B5 + zox.e;
            rH2S.B1 = zox.c.*rH2S.A5 + zox.d.*rH2S.B5 + zox.f;
        ...
        function [H2S, flxH2S, e, dedz, f, dfdz, g, dgdz] = calcH2S(obj, z, bsd, swi, r)
            ...
            if(swi.TwoG_OM_model)
                ...
                elseif z <= r.zfeIII % layer 3
                    [ e, dedz, f, dfdz, g, dgdz]  = r.zTOC.calcfg_l12(z, bsd, swi, r, 0 , 0 , 0, rH2S.ls3);
                    H2S     = r.rH2S.A3.*e + r.rH2S.B3.*f + g;
                    flxH2S  = D.*(r.rH2S.A3.*dedz+r.rH2S.B3.*dfdz + dgdz);
                elseif z <= r.zso4
                    [ e, dedz, f, dfdz, g, dgdz]  = r.zTOC.calcfg_l12(z, bsd, swi, r, obj.reac1, obj.reac2 , 0, rH2S.ls4);
                    H2S     = r.rH2S.A4.*e + r.rH2S.B4.*f + g;
                    flxH2S  = D.*(r.rH2S.A4.*dedz+r.rH2S.B4.*dfdz + dgdz);
                else
                    [ e, dedz, f, dfdz, g, dgdz]  = r.zTOC.calcfg_l12(z, bsd, swi, r, 0,       0 , 0, rH2S.ls5);
                    H2S     = r.rH2S.A5.*e + r.rH2S.B5.*f + g;
                    flxH2S  = D.*(r.rH2S.A5.*dedz+r.rH2S.B5.*dfdz + dgdz);
                end
            else
                if z <= r.zox   % layer 1
                    [ e, dedz, f, dfdz, g, dgdz]  = r.zTOC_RCM.calcfg_l12(z, bsd, swi, r, 0 , 0, rH2S.ls1);
                    H2S     = r.rH2S.A1.*e + r.rH2S.B1.*f + g;
                    flxH2S  = D.*(r.rH2S.A1.*dedz+r.rH2S.B1.*dfdz + dgdz);
                elseif z <= r.zno3 % layer 2
                    [ e, dedz, f, dfdz, g, dgdz]  = r.zTOC_RCM.calcfg_l12(z, bsd, swi, r, 0 , 0, rH2S.ls2);
                    H2S     = r.rH2S.A2.*e + r.rH2S.B2.*f + g;
                    flxH2S  = D.*(r.rH2S.A2.*dedz+r.rH2S.B2.*dfdz + dgdz);
                elseif z <= r.zfeIII % layer 3
                    [ e, dedz, f, dfdz, g, dgdz]  = r.zTOC_RCM.calcfg_l12(z, bsd, swi, r, 0 , 0, rH2S.ls3);
                    H2S     = r.rH2S.A3.*e + r.rH2S.B3.*f + g;
                    flxH2S  = D.*(r.rH2S.A3.*dedz+r.rH2S.B3.*dfdz + dgdz);
                elseif z <= r.zso4
                    [ e, dedz, f, dfdz, g, dgdz]  = r.zTOC_RCM.calcfg_l12(z, bsd, swi, r, obj.reac1,  0, rH2S.ls4);
                    H2S     = r.rH2S.A4.*e + r.rH2S.B4.*f + g;
                    flxH2S  = D.*(r.rH2S.A4.*dedz+r.rH2S.B4.*dfdz + dgdz);
                else
                    [ e, dedz, f, dfdz, g, dgdz]  = r.zTOC_RCM.calcfg_l12(z, bsd, swi, r, 0 , 0, rH2S.ls5);
                    H2S     = r.rH2S.A5.*e + r.rH2S.B5.*f + g;
                    flxH2S  = D.*(r.rH2S.A5.*dedz+r.rH2S.B5.*dfdz + dgdz);
                end
